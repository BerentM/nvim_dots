...
vim.keymap.set("n", "<leader><F3>", "<cmd>lua require'dap'.step_over()<CR>")
vim.keymap.set("n", "<leader><F2>", "<cmd>lua require'dap'.step_into()<CR>")
vim.keymap.set("n", "<leader><F12>", "<cmd>lua require'dap'.step_out()<CR>")
